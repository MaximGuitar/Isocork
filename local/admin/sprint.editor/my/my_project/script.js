sprint_editor.registerBlock('my_project', function ($, $el, data, settings) {
    ...
    this.afterRender = function () {
        ...
        $el.on('click', '.my_projects__sp-item-del', function (evt) {
    ...
    var sendrequest = function (requestParams, callback) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $jresult.html(
                    sprint_editor.renderTemplate('my_project-select', result)
                );
