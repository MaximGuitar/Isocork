sprint_editor.registerBlock('my_render', function ($, $el, data, settings, currentEditorParams) {
    ...
    this.afterRender = function () {
        ...
        function addTab(tabData) {
            var $tab = $(sprint_editor.renderTemplate('my_render-tab', {
                blocklist: blocklist
            }));
        ...
        function addblock(blockData, $tabcontainer) {
            ...
            var $box = $(sprint_editor.renderTemplate('my_render-box', {
                uid: uid,
