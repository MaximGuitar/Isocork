sprint_editor.registerBlock('my_specifications__tabs', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'my_specifications_content', title: 'Таб'},
    ];
    ...
    this.afterRender = function () {
        ...
        var $btn = $el.find('.my_specifications_content__sp-file');
        ...
        $el.on('click', '.my_specifications_content__sp-item-del-file', function () {
            deletefiles();
            data.file = {};
            renderfiles();
        });
        ...
        function addTab(tabData) {
            var $tab = $(sprint_editor.renderTemplate('my_specifications__tabs-tab', {
                blocklist: blocklist
            }));
            ...
            if(tabData.blocks.length === 0) {
                addblock(
                    {
                        name: 'my_specifications_content'
                    },
                    $tabcontainer
                );
            }
        ...
        function addblock(blockData, $tabcontainer) {
            ...
            var $box = $(sprint_editor.renderTemplate('my_specifications__tabs-box', {
                uid: uid,
