sprint_editor.registerBlock('my_news', function ($, $el, data, settings) {
    ...
    var sendrequest = function (requestParams, callback) {
        ...
        $.ajax({
            url: sprint_editor.getBlockWebPath('my_news') + '/ajax.php',
            type: 'post',
            data: requestParams,
            dataType: 'json',
            success: function (result) {
                ...
                $jresult.html(
                    sprint_editor.renderTemplate('my_news-select', result)
                );
    ...
    $el.on('click', '.my_news__sp-item-del', function (evt) {
