sprint_editor.registerBlock('my_render_select', function ($, $el, data, settings) {
    ...
    this.collectData = function () {
        ...
        data.type = $el.find('.sp-select-type').val()
        return data;
    };
    ...
    this.afterRender = function () {
        ...
        $el.on('click', '.my_render_selects__sp-item-del', function (evt) {
            var $image = $(evt.target).closest('.sp-item');;
            $image.remove();
        });
    ...
    var sendrequest = function (requestParams, callback) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $jresult.html(
                    sprint_editor.renderTemplate('my_render_select-select', result)
                );
