sprint_editor.registerBlock('my_primery_rabot_do_posle', function ($, $el, data, settings) {
    ...
    this.afterRender = function () {
        ...
        $el.on('click', '.my_primery_rabot_do_posles__sp-item-del', function (evt) {
    ...
    var sendrequest = function (requestParams, callback) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $jresult.html(
                    sprint_editor.renderTemplate('my_primery_rabot_do_posle-select', result)
                );
